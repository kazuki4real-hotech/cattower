...
realtime Workerも2026-07-14に初回production deployを完了した。2026-07-15にWeb/Realtime両Workerへ同一の`TOWN_TICKET_SECRET`を登録し、5分signed ticketによるproduction WebSocket upgradeと`connection.ready`応答を確認した。
