...
- [ ] P1-17 R2 binding で upload 後 metadata を確認し、Images Binding `.info()` と derivative 生成、入力上限、EXIF、animated/巨大画像を検証する（PNGのmetadata、5712×4284の`.info()`、10MB上限は本番確認済み。derivative、EXIF、animated/巨大画像を確認する）
