...
- [ ] P0-09 無料枠の画像容量・動画分数を決定する

Exit criteria: P0-07〜09 は実装開始を妨げないが、public beta 前に決定する。
...
- [ ] P1-16 R2 への browser direct image upload の smoke test
- [ ] P1-17 iPhone 写真の orientation と metadata 処理を検証する
- [ ] P1-18 Stream Direct Creator Upload で MOV を upload/playback する
...
- [ ] P2-04 household と role policy を domain package に実装する
