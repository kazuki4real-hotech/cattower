...
- [ ] P2-03 登録後 onboarding（利用者名、最初の猫、暮らし方、完了演出）と user preferences を実装する
- [x] P2-03UI onboarding 4 画面の UI、画面遷移、選択操作、完了演出を実装する
- [ ] P2-03A onboarding の途中保存、再開、skip、reduced-motion を実装する
