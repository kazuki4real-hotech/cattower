...
- [ ] P1-16 bucket 限定 R2 access key、Worker 内 SigV4 署名、localhost/production CORS を含む browser direct upload の smoke test（API、SigV4、token、metadata/decode検査、CORS、画面別の失敗理由表示は実装済み。認証済みブラウザでE2Eを再確認する）
