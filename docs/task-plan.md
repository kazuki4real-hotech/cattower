...
- [ ] P1-16 bucket 限定 R2 access key、Worker 内 SigV4 署名、localhost/production CORS を含む browser direct upload の smoke test（API、SigV4、metadata/decode 検査、CORS は実装済み。token を登録して E2E を行う）
