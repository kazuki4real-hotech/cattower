...
export function SettingsExperience() {
  return <Tabs.Root className="settings-grid" defaultValue="town"><Tabs.List className="settings-tabs" aria-label="設定の分類"><Tabs.Trigger className="settings-tab" value="town">猫町</Tabs.Trigger><Tabs.Trigger className="settings-tab" value="family">家族</Tabs.Trigger><Tabs.Trigger className="settings-tab" value="data">データ</Tabs.Trigger></Tabs.List><div>
    <Tabs.Content className="settings-panel" value="town"><p className="eyebrow">猫町への参加</p><h2>あなたとこむぎの設定</h2><div className="setting-row"><div><h3>あなたが猫町へ入る</h3><p>オフにしても私室と収蔵棚はすべて使えます。</p></div><SettingSwitch label="あなたが猫町へ入る" checked /></div><div className="setting-row"><div><h3>こむぎを家族が連れ出す</h3><p>おうちの家族が、こむぎと猫町へ入れます。</p></div><select aria-label="こむぎの猫町公開設定" defaultValue="家族も可"><option>家族も可</option><option>所有者だけ</option><option>参加しない</option></select></div><div className="setting-row"><div><h3>一日一回のまとめ</h3><p>猫町での気配を、Web内通知だけで受け取ります。</p></div><SettingSwitch label="一日一回のまとめ通知" /></div></Tabs.Content>
