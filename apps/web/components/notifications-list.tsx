...
const notices = [["家族への招待が承認されました", "さくらさんが、こむぎのおうちに参加しました。", "今日"], ["データの書き出しが完了しました", "設定から7日間ダウンロードできます。", "昨日"], ["共有URLの期限が近づいています", "「夕方の窓辺」の共有は、あと2日で終了します。", "7月10日"], ["猫町の昨日のまとめ", "こむぎは中庭で、見かけた猫と静かに過ごしました。", "7月9日"]] as const;
