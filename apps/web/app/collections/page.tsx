...
export default function CollectionsPage() {
  return <AppShell>
    <PageHeading eyebrow="あしあと" title="コレクション" description="時間順ではなく、意味ごとにしまう場所。" actions={<button className="button button-secondary" type="button"><Icon name="add" />新しい棚</button>} />
