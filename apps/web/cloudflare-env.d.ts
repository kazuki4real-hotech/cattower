/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: ff5dd1c6de1799efd5cf27671b1bc622)
// Runtime types generated with workerd@1.20260708.1 2026-07-14 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	MEDIA: R2Bucket;
	DB: D1Database;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	R2_ACCOUNT_ID: "54bfb2e5aa9452060620308a6f0e6e73";
	R2_BUCKET_NAME: "cattower-media-production";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "R2_ACCOUNT_ID" | "R2_BUCKET_NAME">> {}
}
