/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 337b41957a55c10528a43967260895fc)
// Runtime types generated with workerd@1.20260708.1 2026-07-14 nodejs_compat
interface __BaseEnv_CloudflareEnv {
  ALLOWED_WEB_ORIGINS: "https://cattower-web.kazuki-kitada.workers.dev,http://localhost:3000";
  TOWN_ROOM: DurableObjectNamespace<import("./src/index").TownRoom>;
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./src/index");
    durableNamespaces: "TownRoom";
  }
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, "ALLOWED_WEB_ORIGINS">
  > {}
}
